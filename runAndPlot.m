...
subcritical = 1; %Use this only if f is a homogeneous function with a subcritical instability and qc is 1. Set to 0 to save time.
...
A = RunGLESimulation(rp, tp, alpha, beta, params, Us);
